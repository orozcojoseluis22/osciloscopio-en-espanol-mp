...
const Hero = () => {
  ...
  return <div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <img alt="Osciloscopio en uso" style={{
              maxWidth: "400px"
            }} src="https://www.electronicayservicio.com/assets/images/sliders/aplicacionosciloscopio.jpg" className="w-full h-auto rounded object-fill" />
            </div>
          </div>
        </div>
      </div>
